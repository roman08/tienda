    ...
    <div class="profile-content">
        <div class="container">
            <div class="row">
                <div class="profile">
                    <div class="avatar">
                        <img src="{{asset('/img/search.png')}}" alt="Imagen lupa para resultados de búsqueda" class="img-circle img-responsive img-raised">
                    </div>
            ...
            <div class="description text-center">
                <p>Se encontaron {{ $products->count() }} resultados para el termino {{$query}}</p>
            </div>
